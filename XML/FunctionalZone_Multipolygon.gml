...
<!--
    ...
    Пример векторной карты размещаемой на портале федеральной
    государственной информационной системы территориального
    планирования (ФГИС ТП). GML-файл составлен в соответствии
    с XML-схемой fgistp.xsd
 -->
<gml:FeatureCollection gml:id="i128143426" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://fgistp fgistp.xsd" xmlns="http://fgistp" xmlns:gml="http://www.opengis.net/gml/3.2">
    ...
    <gml:featureMember>
        <FunctionalZone gml:id="ID_339aaa41-9834-4a74-aea5-bdc7e467bb2f">
    ...
    <gml:featureMember>
        <FunctionalZone gml:id="ID_ba254e3c-7544-4873-9b84-f5136e365e21">
    ...
    <gml:featureMember>
        <FunctionalZone gml:id="ID_4502e97f-efe8-4983-a622-ecf234183599">
    ...
    <gml:featureMember>
        <FunctionalZone gml:id="ID_cc807d41-441c-495b-919b-46cadba30971">
