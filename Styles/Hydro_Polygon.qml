...
<qgis version="3.28.15-Firenze" styleCategories="Symbology">
  <renderer-v2 type="RuleRenderer" referencescale="-1" symbollevels="0" forceraster="0" enableorderby="0">
    <rules key="{614b102a-da35-4d94-b791-5de650ffb005}">
      <rule symbol="0" label="Существующие" filter="&quot;STATUS&quot; = 1" key="{8d37b43a-4e8c-438a-8d7c-de592d892600}">
        <rule symbol="1" label="Море или его отдельная часть (пролив, залив, в том числе бухта, лиман и другие)" filter="&quot;CLASSID&quot; = '706020100'" key="{d90a23ee-3223-41e3-bcc9-ec90206f347b}"/>
        <rule symbol="2" label="Водоток (река, ручей, канал)" filter="&quot;CLASSID&quot; = '706020200'" key="{e15664e7-3114-4bc8-9f7d-73bb85461965}"/>
        <rule symbol="3" label="Водоем (озеро, пруд, обводненный карьер, водохранилище)" filter="&quot;CLASSID&quot; = '706020300'" key="{a47789dc-2b3e-4d18-b205-bd7561a7fd1f}"/>
        <rule symbol="4" label="Болото" filter="&quot;CLASSID&quot; = '706020400'" key="{67da5c72-e0b8-4e60-8caa-c6a6082707fd}"/>
        <rule symbol="5" label="Ледник, снежник" filter="&quot;CLASSID&quot; = '706020600'" key="{e7cd1505-2f40-4b0c-a5e9-a64ded976608}"/>
      </rule>
      <rule symbol="6" label="Планируемые" filter="&quot;STATUS&quot; = 2" key="{3e719325-cdc5-44ce-8e0c-4316c1a3e869}">
        <rule symbol="7" label="Водоток (река, ручей, канал)" filter="&quot;CLASSID&quot; = '706020200'" key="{f277a56f-3182-46d8-94b7-fdde4d75299a}"/>
        <rule symbol="8" label="Водоем (озеро, пруд, обводненный карьер, водохранилище)" filter="&quot;CLASSID&quot; = '706020300'" key="{0a0a640e-4687-4658-a99c-156e7190c474}"/>
      </rule>
    </rules>
    <symbols>
      ...
      <symbol frame_rate="10" type="fill" force_rhr="0" is_animated="0" alpha="1" name="1" clip_to_extent="1">
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleFill">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
            <Option value="208,248,253,255" type="QString" name="color"/>
            <Option value="miter" type="QString" name="joinstyle"/>
            <Option value="0,0" type="QString" name="offset"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
            <Option value="MM" type="QString" name="offset_unit"/>
            <Option value="0,155,196,255" type="QString" name="outline_color"/>
          ...
          <symbol frame_rate="10" type="line" force_rhr="0" is_animated="0" alpha="1" name="@4@0" clip_to_extent="1">
            ...
            <layer enabled="1" locked="0" pass="0" class="SimpleLine">
              <Option type="Map">
                ...
                <Option value="miter" type="QString" name="joinstyle"/>
                <Option value="0,155,196,255" type="QString" name="line_color"/>
      ...
      <symbol frame_rate="10" type="fill" force_rhr="0" is_animated="0" alpha="1" name="5" clip_to_extent="1">
        ...
        <layer enabled="1" locked="0" pass="0" class="PointPatternFill">
          <Option type="Map">
            ...
            <Option value="760431179" type="QString" name="seed"/>
          </Option>
          <data_defined_properties>
            <Option type="Map">
              <Option value="" type="QString" name="name"/>
          ...
          <symbol frame_rate="10" type="marker" force_rhr="0" is_animated="0" alpha="1" name="@5@0" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" locked="0" pass="0" class="SimpleMarker">
              <Option type="Map">
                ...
                <Option value="0,155,196,255" type="QString" name="color"/>
                ...
                <Option value="0.15" type="QString" name="size"/>
