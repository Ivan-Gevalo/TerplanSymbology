...
<qgis version="3.28.15-Firenze" styleCategories="Symbology">
  <renderer-v2 referencescale="-1" type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0">
    <rules key="{9412bfe2-02d9-4d1b-a117-2b0ad6b8440a}">
      <rule key="{edf0de8a-aa56-41eb-9ad1-2f029ea6953e}" label="Существующие, строящиеся объекты местного значения, иного значения" symbol="0" filter="&quot;STATUS&quot; = 1 AND &quot;REG_STATUS&quot; IN (3, 4, 5, 6, 8)">
        <rule key="{08718a8c-a5bc-4eba-b149-e8b59bdab3d7}" label="Иные объекты регионального значения, объекты местного значения, установленные в соответствии с законодательством" symbol="1" filter="&quot;CLASSID&quot; = '602050601'"/>
      </rule>
      <rule key="{cb8636bc-0d0c-4312-84e1-0e77298edcab}" label="Планируемые к размещению объекты местного значения, иного значения" symbol="2" filter="&quot;STATUS&quot; = 2 AND &quot;REG_STATUS&quot; IN (3, 4, 5, 6, 8)">
        <rule key="{354f03b9-9626-4877-8240-732d748b6b9d}" label="Иные объекты регионального значения, объекты местного значения, установленные в соответствии с законодательством" symbol="3" filter="&quot;CLASSID&quot; = '602050601'"/>
      </rule>
      <rule key="{4d32a0d7-4f58-4cfe-9452-091ab2feae9e}" label="Планируемые к реконструкции объекты местного значения, иного значения" symbol="4" filter="&quot;STATUS&quot; = 3 AND &quot;REG_STATUS&quot; IN (3, 4, 5, 6, 8)">
        <rule key="{d43a4f01-f7da-41d3-b32a-554486b41507}" label="Иные объекты регионального значения, объекты местного значения, установленные в соответствии с законодательством" symbol="5" filter="&quot;CLASSID&quot; = '602050601'"/>
      </rule>
      <rule key="{db6272f2-d006-42bf-ba6c-496dc39a2668}" label="Планируемые к ликвидации объекты местного значения, иного значения" symbol="6" filter="&quot;STATUS&quot; = 4 AND &quot;REG_STATUS&quot; IN (3, 4, 5, 6, 8)">
        <rule key="{815298bf-d39c-43fc-bbe9-5c2f5fa47e24}" label="Иные объекты регионального значения, объекты местного значения, установленные в соответствии с законодательством" symbol="7" filter="&quot;CLASSID&quot; = '602050601'"/>
      </rule>
      <rule key="{55634ad0-f4b5-429c-9391-c398d730d22d}" label="Существующие, строящиеся объекты регионального значения" symbol="8" filter="&quot;STATUS&quot; = 1 AND &quot;REG_STATUS&quot; = 2">
        <rule key="{992d8191-3b07-429c-ba46-6fb39b5d91de}" label="Иные объекты регионального значения, объекты местного значения, установленные в соответствии с законодательством" symbol="9" filter="&quot;CLASSID&quot; = '602050601'"/>
      </rule>
      <rule key="{16634290-57ce-42bb-ad15-44a8ba32c8d8}" label="Планируемые к размещению объекты регионального значения" symbol="10" filter="&quot;STATUS&quot; = 2 AND &quot;REG_STATUS&quot; = 2">
        <rule key="{0874c41e-926b-4ddb-b87b-1691ab393b32}" label="Иные объекты регионального значения, объекты местного значения, установленные в соответствии с законодательством" symbol="11" filter="&quot;CLASSID&quot; = '602050601'"/>
      </rule>
      <rule key="{c599fec9-9fc0-4f75-bcd1-a6903397abc2}" label="Планируемые к реконструкции объекты регионального значения" symbol="12" filter="&quot;STATUS&quot; = 3 AND &quot;REG_STATUS&quot; = 2">
        <rule key="{716b8716-ef98-4bba-b5b4-5a794a4f7dfc}" label="Иные объекты регионального значения, объекты местного значения, установленные в соответствии с законодательством" symbol="13" filter="&quot;CLASSID&quot; = '602050601'"/>
      </rule>
      <rule key="{3928ce06-0248-46ee-a1d0-49ea186f7658}" label="Планируемые к ликвидации объекты регионального значения" symbol="14" filter="&quot;STATUS&quot; = 4 AND &quot;REG_STATUS&quot; = 2">
        <rule key="{bc2601d2-8392-4e71-8cfe-3d3865c69c90}" label="Иные объекты регионального значения, объекты местного значения, установленные в соответствии с законодательством" symbol="15" filter="&quot;CLASSID&quot; = '602050601'"/>
      </rule>
      <rule key="{1345c6a0-bb49-4187-b75f-b04be9e4b791}" label="Существующие, строящиеся объекты федерального значения" symbol="16" filter="&quot;STATUS&quot; = 1 AND &quot;REG_STATUS&quot; = 1">
        <rule key="{b82cc9a2-cd23-49a9-b48a-3c38ed136038}" label="Иные объекты регионального значения, объекты местного значения, установленные в соответствии с законодательством" symbol="17" filter="&quot;CLASSID&quot; = '602050601'"/>
      </rule>
      <rule key="{3c317753-d730-447c-9bd6-a4269477d580}" label="Планируемые к размещению объекты федерального значения" symbol="18" filter="&quot;STATUS&quot; = 2 AND &quot;REG_STATUS&quot; = 1">
        <rule key="{f8f1423a-40c8-45aa-bd3c-dfeb8debbb55}" label="Иные объекты регионального значения, объекты местного значения, установленные в соответствии с законодательством" symbol="19" filter="&quot;CLASSID&quot; = '602050601'"/>
      </rule>
      <rule key="{e7285ac7-ca26-4635-8b6f-1588e9f14df2}" label="Планируемые к реконструкции объекты федерального значения" symbol="20" filter="&quot;STATUS&quot; = 3 AND &quot;REG_STATUS&quot; = 1">
        <rule key="{24ae01a0-a503-4e23-ba89-c83d8659a036}" label="Иные объекты регионального значения, объекты местного значения, установленные в соответствии с законодательством" symbol="21" filter="&quot;CLASSID&quot; = '602050601'"/>
      </rule>
      <rule key="{4b7b0207-6dec-4d8a-9022-770cda92fbca}" label="Планируемые к ликвидации объекты федерального значения" symbol="22" filter="&quot;STATUS&quot; = 4 AND &quot;REG_STATUS&quot; = 1">
        <rule key="{a83402c9-af7e-4f5a-a10a-070abda66fcc}" label="Иные объекты регионального значения, объекты местного значения, установленные в соответствии с законодательством" symbol="23" filter="&quot;CLASSID&quot; = '602050601'"/>
      </rule>
    </rules>
    <symbols>
      ...
      <symbol type="marker" alpha="1" force_rhr="0" clip_to_extent="1" name="1" is_animated="0" frame_rate="10">
        ...
        <layer pass="0" class="SvgMarker" enabled="1" locked="0">
          <Option type="Map">
            ...
            <Option type="QString" value="0" name="fixedAspectRatio"/>
            <Option type="QString" value="1" name="horizontal_anchor_point"/>
            <Option type="QString" value="base64:" name="name"/>
            <Option type="QString" value="0,0" name="offset"/>
            <Option type="QString" value="3x:0,0,0,0,0,0" name="offset_map_unit_scale"/>
            <Option type="QString" value="MM" name="offset_unit"/>
            <Option type="QString" value="35,35,35,255" name="outline_color"/>
