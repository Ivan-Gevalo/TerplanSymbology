...
<qgis version="3.28.9-Firenze" styleCategories="Symbology">
  <renderer-v2 symbollevels="0" forceraster="0" referencescale="-1" type="RuleRenderer" enableorderby="0">
    <rules key="{7da88c3e-bf5f-4385-9903-c5d5547941ba}">
      <rule label="Существующая территория населенного пункта" key="{2f77fd04-7c28-41a0-ba32-070dc06a68d5}" filter=" &quot;STATUS_ADM&quot; = 1" symbol="0"/>
      <rule label="Планируемая территория населенного пункта" key="{f1a37ef3-2fef-4e73-ba56-8692374492fc}" filter=" &quot;STATUS_ADM&quot; = 2" symbol="1"/>
    </rules>
    <symbols>
      <symbol name="0" frame_rate="10" type="fill" force_rhr="0" alpha="1" is_animated="0" clip_to_extent="1">
      ...
      <symbol name="1" frame_rate="10" type="fill" force_rhr="0" alpha="1" is_animated="0" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
