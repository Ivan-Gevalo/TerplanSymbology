...
<qgis styleCategories="Symbology" version="3.28.12-Firenze">
  <renderer-v2 referencescale="-1" type="RuleRenderer" forceraster="0" symbollevels="0" enableorderby="0">
    <rules key="{d5866bee-8d87-4711-b4df-d170ed16c0f5}">
      <rule key="{92d6d6c8-d762-4c93-aa2a-d7dd3273a5f5}" symbol="0" filter="&quot;STATUS&quot; = 1 AND &quot;REG_STATUS&quot; = 1" label="Существующие, строящиеся объекты федерального значения">
        <rule key="{fdd6167e-cad2-4a69-ba46-064cd268880c}" symbol="1" filter="&quot;CLASSID&quot; = '602050101'" label="Объект ФСИН России"/>
      </rule>
      <rule key="{00e5feec-7d33-41bf-a6b1-550243bcba59}" symbol="2" filter="&quot;STATUS&quot; = 2 AND &quot;REG_STATUS&quot; = 1" label="Планируемые к размещению объекты федерального значения">
        <rule key="{59716d70-b729-4010-8e77-6a6d5c0dcf81}" symbol="3" filter="&quot;CLASSID&quot; = '602050101'" label="Объект ФСИН России"/>
      </rule>
      <rule key="{b25a86d1-225e-43e8-9930-b91255a6a6a0}" symbol="4" filter="&quot;STATUS&quot; = 3 AND &quot;REG_STATUS&quot; = 1" label="Планируемые к реконструкции объекты федерального значения">
        <rule key="{f19570c2-e208-43da-999a-396680f32492}" symbol="5" filter="&quot;CLASSID&quot; = '602050101'" label="Объект ФСИН России"/>
      </rule>
      <rule key="{c1e8629a-a6bf-45fb-9a1b-f337ca0aae80}" symbol="6" filter="&quot;STATUS&quot; = 4 AND &quot;REG_STATUS&quot; = 1" label="Планируемые к ликвидации объекты федерального значения">
        <rule key="{6957aa9e-ec9c-446f-8bb7-1c9184ea3d13}" symbol="7" filter="&quot;CLASSID&quot; = '602050101'" label="Объект ФСИН России"/>
      </rule>
    </rules>
    <symbols>
      <symbol name="0" force_rhr="0" type="marker" frame_rate="10" clip_to_extent="1" is_animated="0" alpha="1">
      ...
      <symbol name="1" force_rhr="0" type="marker" frame_rate="10" clip_to_extent="1" is_animated="0" alpha="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
      ...
      <symbol name="2" force_rhr="0" type="marker" frame_rate="10" clip_to_extent="1" is_animated="0" alpha="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
      ...
      <symbol name="3" force_rhr="0" type="marker" frame_rate="10" clip_to_extent="1" is_animated="0" alpha="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
      ...
      <symbol name="4" force_rhr="0" type="marker" frame_rate="10" clip_to_extent="1" is_animated="0" alpha="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
      ...
      <symbol name="5" force_rhr="0" type="marker" frame_rate="10" clip_to_extent="1" is_animated="0" alpha="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
      ...
      <symbol name="6" force_rhr="0" type="marker" frame_rate="10" clip_to_extent="1" is_animated="0" alpha="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
      ...
      <symbol name="7" force_rhr="0" type="marker" frame_rate="10" clip_to_extent="1" is_animated="0" alpha="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer class="SvgMarker" enabled="1" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option name="parameters"/>
            <Option name="scale_method" type="QString" value="diameter"/>
            <Option name="size" type="QString" value="5.93"/>
            <Option name="size_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="size_unit" type="QString" value="MM"/>
            <Option name="vertical_anchor_point" type="QString" value="1"/>
          </Option>
